                ...
                if len(outputs[i]) > 0:
                    for j, (output) in enumerate(outputs[i]):
                        ...
                        if save_txt:
                            ...
                            #boxes = [bbox_left_mid, bbox_top_mid, bbox_w, bbox_h]
                        ...
                        if save_vid or save_crop or show_vid:  # Add bbox to image
                            ...
                            text_ocr = ocr_image(im0, bboxes)
                            print("------------------------------------------------------------bboxes here--------------------------------------------------------------")
                            print(bboxes)
                            #bbox_left_mid = int((output[0] + output[2]) / 2)
                            #bbox_top_mid = int((output[1] + output[3]) / 2)
                            #boxes = [bbox_left_mid, bbox_top_mid, bbox_w, bbox_h]
                            label = f'{id:0.0f} {names[c]} {text_ocr} {conf:.2f}'
                            #label = f'{id:0.0f} {text_ocr} {conf:.2f}'
